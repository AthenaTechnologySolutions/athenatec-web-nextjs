...
export default function ArticlesPage() {
  ...
  return (
    <>
      ...
      <HeroSection
        title="Articles & Manufacturing Insights"
        description="Eliminate fixed workstation delays and manual errors. Athena's Mobility Accelerator puts real-time data capture in operators' hands, syncing instantly with your MES."
        image="/assets/images/shopfloor.webp"
        align="center"
