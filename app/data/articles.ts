...
export const articles: Article[] = [
  {
    ...
    content: {
      ...
      webinarCallout: {
        ...
        description: "Join Naveen Sedhuraman and Maryanne Steidinger as they walk through how connected handheld technology helps manufacturers modernize production data capture and derive maximum value from existing MES platforms.",
