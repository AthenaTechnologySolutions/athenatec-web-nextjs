                    ...
                    <div className="rf-success-detail">
                        ...
                        <span className="rf-success-item">
                            <Image
                                ...
                                height={18}
                            />
                            <span>Registration deadline: July 16, 2026, 9:00 PM PST</span>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div className="rf-page">
            ...
            <div className="rf-shell">
                ...
                <div className="rf-deadline-note">
                    <strong>Deadline for registration:</strong> July 16, 2026, at 9:00 PM PST.
                    <span>Please note: Registration may close earlier if the maximum number of participants is reached before the deadline.</span>
                </div>
